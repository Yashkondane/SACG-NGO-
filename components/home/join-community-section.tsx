...
export function JoinCommunitySection({ content }: JoinCommunitySectionProps) {
    return (
        <section className="py-24 bg-primary text-primary-foreground relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 text-center relative z-10">
                <FadeIn direction="up">
                    <h2 className="text-3xl md:text-4xl font-bold mb-6 text-balance">{content?.title || "Join Our Community"}</h2>
                </FadeIn>
                <FadeIn delay={0.2} direction="up">
                    <p className="text-lg mb-8 max-w-2xl mx-auto text-balance opacity-90">
                        {content?.description || "Become part of something bigger. Connect with your community, celebrate your heritage, and make a difference."}
                    </p>
                </FadeIn>
